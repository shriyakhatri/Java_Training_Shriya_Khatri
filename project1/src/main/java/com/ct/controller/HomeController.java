...
public class HomeController {
   ...
   @RequestMapping("/")
	...
	@RequestMapping("/cart")
	public  ModelAndView  addToCart(@RequestParam("id") int id, @RequestParam("name") String name , @RequestParam("description") String description, @RequestParam("price") int price, @RequestParam("discount") int discount ,  @RequestParam("quantity") int quantity, HttpServletRequest request)
	{
		ModelAndView mv=new ModelAndView();
		HttpSession session = request.getSession();
		System.out.println("idddddd "+id);
		System.out.println("nameee");
	    Product p = new Product(id,name,price,quantity,description,discount);
